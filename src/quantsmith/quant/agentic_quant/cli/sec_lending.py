...
Usage
-----
  quantsmith-sec-lending                        # default synthetic demo
  quantsmith-sec-lending --db path/to/lend.db  # local SQLite file
  quantsmith-sec-lending --max-book 500000000   # custom book limit ($500M)
  quantsmith-sec-lending --no-ml               # skip ML demand forecast
  quantsmith-sec-lending --combined            # portfolio + sec lending
"""
