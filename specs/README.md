...
Specs `0001`, `0006`–`0013`, `0015`, `0016`, `0018`–`0021`, `0028`, `0034`–`0036`, `0038`, `0039`, `0041`, `0042`, `0044`–`0046`, and `0048` have dependency-free reference runtimes under
...
| [0055-workflow-scheduling-operations](0055-workflow-scheduling-operations/) | Workflow scheduling operations — cron/jobs/scripts/workflows, status ledger, manual reminders, daily reports | — (planned control plane) | planned scheduler/report tests | Draft |
...
**Next free spec number: `0056`** (`0003`/`0005` belong to the local-only pack).
