...
or model-monitoring request into an executable, reviewable workflow plan.
...
modeling, trading strategy, backtest review, and risk agents into a coherent plan
or executable prototype.
...
- Risk limits, operational constraints, and review gates.

## Outputs

- Workflow decomposition and agent routing.
- Data, feature, model, backtest, and risk assumptions.
