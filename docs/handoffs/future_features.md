...
| BI-tool profiles: `tooling/looker`, `tooling/qlik`, `tooling/superset`, `tooling/streamlit_dash` | Thin profiles that render the shared dashboard spec from `dashboard_design` (spec `0014` track) | P2 | proposed |
