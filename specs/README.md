...
Specs `0001`, `0006`–`0013`, `0015`, and `0016` have dependency-free reference runtimes under
...
- **Data Analyst:** `0008` metrics → `0009` experimentation → `0010` end-to-end
  pipeline → `0014` storytelling & dashboards → `0015`/`0016` dashboard profiles (Power BI, Excel, React) → `0017` executable render adapters (communication layer).
...
**Next free spec number: `0018`** (`0003`/`0005` belong to the local-only pack).
