...
Specs `0001`, `0006`–`0013`, `0015`, `0016`, `0018`–`0021`, `0028`, `0034`–`0036`, `0038`, `0039`, `0041`, `0042`, and `0044`–`0046` have dependency-free reference runtimes under
...
| [0048-workflow-memory-runtime](0048-workflow-memory-runtime/) | Workflow memory runtime & author attribution — makes `0002`'s store machine-readable: typed records, a type-aware point-in-time rule (mechanical facts are timeless, claims about what worked are bounded by `last_confirmed`), contradiction and supersession validation, derived corroboration, decay against the `freshness_days` nothing has ever read, and an author handle structurally incapable of being an email | — (runtime not yet built) | — (not yet built) | Approved |
...
**Next free spec number: `0049`** (`0003`/`0005` belong to the local-only pack).
