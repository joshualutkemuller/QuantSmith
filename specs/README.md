...
| [0024-workflow-scheduling-operations](0024-workflow-scheduling-operations/) | Workflow scheduling operations — cron/jobs/scripts/workflows, status ledger, manual reminders, daily reports | — (planned control plane) | planned scheduler/report tests | Draft |
...
- **Scheduled operations:** `0024` workflow scheduling operations → scheduler adapters
  (`cron`, GitHub Actions, Airflow, Dagster/Prefect) → run ledger → daily status
  report → `0020` alerting/manual follow-up.
